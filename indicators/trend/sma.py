...
def simple_moving_average(
    ...
    """
    The Simple Moving Average (SMA) is a statistical calculation that computes the average of a selected range of
    prices, usually closing prices, by the number of periods in that range. It smooths out price data to identify
    trends over time.
